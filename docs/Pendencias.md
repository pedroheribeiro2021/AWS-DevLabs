...
- **Content needed for 11 of the 12 empty topics**: tracked with real volume estimates (lessons/labs/questions/flashcards per topic, updated as each one ships) in `docs/Conteudo-DVA-C02.md`, not just this line. The Learning track and Simulations already handle empty topics gracefully in the meantime.
