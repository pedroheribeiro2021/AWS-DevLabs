...
export function XpBanner({ xp, level, streak }: XpBannerProps) {
  ...
  return (
    <div className="flex flex-wrap items-center gap-2 rounded-lg border border-orange-300 bg-orange-50 px-4 py-3 text-sm font-medium text-orange-800">
